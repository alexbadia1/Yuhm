      ...
      child: Row(
        children: [
          ValueListenableBuilder<Controller>(
              ...
              builder: (_, _ctrl, __) {
                return IconButton(
                    tooltip: "Toggle Paint",
                    icon:
                    widget.undoIcon ?? Icon(Icons.brush, color: Colors.grey[700]),
                    onPressed: () {
                      _controller.value = _ctrl.copyWith(mode: _ctrl.mode != PaintMode.none ? PaintMode.none : PaintMode.freeStyle);
                    });
              }),
          const Spacer(),
          IconButton(
